WebSite.Script.Animation = function () {

};
WebSite.Script.Animation.prototype = {
    fnWN: function () {
        var WN = {},
...
//    window.Animation.Gis = window.Animation.Gis || {};
//    if (window.Animation.Gis.Global) throw new Error('Animation.Gis.Global 类重复加载');
//    var mirsGlobal = window.Animation.Gis.Global = function () {
...
//    } else {
//        window.Animation.Gis.Global = root.WN = factory();
//    }
//})(this, function () {
//    var WN = {},
//        body = document.body || document.documentElement,
